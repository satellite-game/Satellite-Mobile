...
s.Sound.prototype.destruct = function() {
  // @todo Remove event listeners from Audio objects?
  this.ready = {};
};

s.Sound.prototype.preload = function() {
  // Preload each sound
...
s.Sound.prototype.create = function(soundUrl) {
...
s.Sound.prototype.getInstance = function(name) {
...
s.Sound.prototype.play = function(name, volume) {
  if (!this.enabled)
    return false;
